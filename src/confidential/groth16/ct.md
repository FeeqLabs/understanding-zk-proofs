...
generate witness
```sh
node src/confidential/groth16/build/confidential_transfer_js/generate_witness.js \
  src/confidential/groth16/build/confidential_transfer_js/confidential_transfer.wasm \
...
npx snarkjs groth16 setup \
  ...
  src/confidential/groth16/build/pot12_final.ptau \
  src/confidential/groth16/build/outputs/confidential_transfer_0000.zkey
```
...
npx snarkjs zkey contribute \
  src/confidential/groth16/build/outputs/confidential_transfer_0000.zkey \
  src/confidential/groth16/build/outputs/confidential_transfer_final.zkey \
...
npx snarkjs groth16 prove \
  ...
  src/confidential/groth16/build/outputs/public-commitment.json
```
...
npx snarkjs zkey export solidityverifier \
  src/confidential/groth16/build/outputs/confidential_transfer_final.zkey \
  src/confidential/contracts/CTVerifier.sol
```
